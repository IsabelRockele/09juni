...
function resetSpel() {
    verwijderWinAnimatie(); // Verwijder Zisa en de fiches
...
controleerBtn.addEventListener("click", () => {
    ...
    // We wachten nu op de speler om zijn fiche te plaatsen
} else {
    // Fout? Beurt wisselt sowieso, niemand mag een fiche plaatsen
    setTimeout(() => {
...
document.getElementById("btn-terug-spel").addEventListener("click", () => {
    verwijderWinAnimatie(); // Verwijder Zisa en fiches bij terugkeer naar menu
